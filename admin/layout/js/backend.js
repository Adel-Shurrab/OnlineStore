...
$(function () {
    $("#inputItem").autocomplete({
            ...
            $.ajax({
                ...
                success: function (data) {
                    response($.map(data, function (item) {
                        return {
                            label: item.item_name, // Displayed in the dropdown
                            value: item.item_name, // Inserted into the input field
                            id: item.item_id      // Captured as the item's ID
                        };
                    }));
                }
            });
        ...
        select: function (event, ui) {
            // Set the hidden input field with the selected item's ID
